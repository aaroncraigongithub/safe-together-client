...
class App extends Component {
  ...
  urlToRoute(url) {
    ...
    return path.replace('safe-together.herokuapp.com/', '').split('/');
  }
  ...
  render() {
    return (
      <RouterWithRedux>
        <Scene key='root'>
          <Scene key='splash' component={Splash} title='Safe Together' initial={true} />
          ...
          <Scene key='alert' component={Alert} title='Safe Together' />
